...
namespace ConvertDatMEA
{
    abstract class DataConverter
    {
        ...
        public static DataConverter FromFormat(string fileExtension, OutputFunction function, ProgressUpdate updater, BinaryWriter datWriter)
        {
            switch (fileExtension)
            {
                case ".MCD":
                    return new McdConverter(function, updater, datWriter);

                case ".MSRD":
                    return new MsrdConverter(function, updater, datWriter);
        ...
        protected DataConverter(OutputFunction function, ProgressUpdate updater, BinaryWriter datWriter)
        {
